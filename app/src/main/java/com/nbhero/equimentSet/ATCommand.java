...
public class ATCommand {
			...
			public void handleMessage(Message msg) {
				switch (msg.what) {
					...
					case CODE_RESET_FAILURE:
						...
						break;
					case CODE_CMD:
						onResponse(msg.getData().getString(RESPONSE),text);
						break;
	...
	private void onResponse(String response,String text) {
		if (listener != null) {
			listener.onResponse(response,text);
		}
	}
	...
	/**
	 * 1：发送A11ASSISTHREAD到10.10.100.254；
	 *2.等待五秒如果服务器没有回复 设置失败
	 * 3.如果有回复：继续发送+ok 发送成功 则表示切换成功；
	 */
